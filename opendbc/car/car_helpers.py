...
def get_car(can_recv: CanRecvCallable, can_send: CanSendCallable, set_obd_multiplexing: ObdCallback, alpha_long_allowed: bool,
            num_pandas: int = 1, top_params: int = 0, cached_params: CarParamsT | None = None):
  ...
  CP: CarParams = CarInterface.get_params(candidate, fingerprints, car_fw, alpha_long_allowed, top_params, docs=False)
  CP.carVin = vin
  CP.carFw = car_fw
